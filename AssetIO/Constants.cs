...
internal static class Constants
{
    ...
    internal const int AssetInfoChunkSize = 8192;
    /// <summary>The size of an asset info chunk header in an asset .pack file (NextOffset + NumAssets).</summary>
    internal const int AssetInfoHeaderSize = 8;
    /// <summary>The size of an asset's fields (Name.Length + Offset + Size + Crc32).</summary>
    internal const int AssetFieldsSize = 16;
